...
- You will learn to deploy Spring Boot REST API with AWS (Amazon Web Services) Elastic Beanstalk
- You will learn to deploy Full Stack and Web Applications developed using Spring Boot/React with AWS (Amazon Web Services) Elastic Beanstalk
...
- You should have prior experience with Java, Basic JavaScript, Spring Framework, Spring Boot, JPA and React. 
- You should have Chrome browser installed.
- You need a valid credit or debit card to create an AWS Account
- We will help you install Eclipse, Docker, Visual Studio Code and Node JS(for npm)
- We will help you install Chrome Restlet Client Plugin and Chrome React DevTools Plugin
- We will help you learn the basics of cloud and aws.
